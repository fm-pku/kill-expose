...
check_selected:
	...
	*/
	...
	@Rep String currentEncoding;

	@Rep boolean autoDetectEncoding;
	...
	//{{{ Instance variables
	@Rep private EventListenerList listenerList;
	@Rep private View view;
	@Rep private boolean horizontalLayout;
	@Rep private String path;
	@Rep private JPanel pathAndFilterPanel;
	@Rep private HistoryTextField pathField;
	@Rep private JComponent defaultFocusComponent;
	@Rep private JCheckBox filterCheckbox;
	@Rep private HistoryComboBoxEditor filterEditor;
	@Rep private JComboBox filterField;
	@Rep private Box toolbarBox;
	@Rep private Box topBox;
	@Rep private FavoritesMenuButton favorites;
	@Rep private PluginsMenuButton plugins;
	@Rep private BrowserView browserView;
	@Rep private int mode;
	@Rep private boolean multipleSelection;

	@Rep private boolean showHiddenFiles;
	@Rep private boolean sortMixFilesAndDirs;
	@Rep private boolean sortIgnoreCase;
	@Rep private boolean doubleClickClose;

	@Rep private boolean requestRunning;
	@Rep private boolean maybeReloadRequestRunning;

	@Rep private final Stack<String> historyStack = new Stack<String>();
	@Rep private final Stack<String> nextDirectoryStack = new Stack<String>();
	//}}}
