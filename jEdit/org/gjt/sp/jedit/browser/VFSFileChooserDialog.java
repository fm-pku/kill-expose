...
public class VFSFileChooserDialog extends EnhancedDialog
{
	...
	//{{{ Instance variables
	@Rep private VFSBrowser browser;
	@Rep private VFSFileNameField filenameField;
	@Rep private String filename;
	@Rep private JButton ok;
	@Rep private JButton cancel;
	@Rep private boolean isOK;
	@Rep private TaskListener ioTaskHandler;
	//}}}
