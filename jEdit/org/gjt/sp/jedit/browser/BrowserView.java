...
class BrowserView extends JPanel
{
	...
	//{{{ Instance variables
	@Rep private final VFSBrowser browser;

	@Rep private final JSplitPane splitPane;
	@Rep private final JList parentDirectories;
	@Rep private final VFSDirectoryEntryTable table;
	@Rep private final Set<String> tmpExpanded;
	@Rep private BrowserCommandsMenu popup;
	@Rep private boolean showIcons;
	//}}}
