...
public class BrowserCommandsMenu extends JPopupMenu
{
	...
	@Rep private HashMap<String, JRadioButtonMenuItem> encodingMenuItems;
	@Rep private JCheckBoxMenuItem autoDetect;
	@Rep private JRadioButtonMenuItem otherEncoding;
