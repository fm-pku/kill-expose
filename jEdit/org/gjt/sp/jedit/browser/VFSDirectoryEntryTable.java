...
public class VFSDirectoryEntryTable extends JTable
{
	...
	//{{{ Private members
	@Rep private final BrowserView browserView;
	@Rep private final JTableHeader header;
	@Rep private final FileCellRenderer renderer;
	@Rep private final StringBuffer typeSelectBuffer = new StringBuffer();
	@Rep private final Timer timer = new Timer(0,new ClearTypeSelect());
	@Rep private boolean resizingColumns;
