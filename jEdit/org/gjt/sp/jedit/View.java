...
//		setEditPane(newEditPane);
	...
	*/
	...
	//{{{ Instance variables
	@Rep private boolean closed;

	@Rep private final DockableWindowManager dockableWindowManager;
	@Rep private final JPanel mainPanel;

	@Rep private final JPanel topToolBars;
	@Rep private final JPanel bottomToolBars;
	@Rep private ToolBarManager toolBarManager;

	@Rep private Container toolBar;
	@Rep private SearchBar searchBar;
	@Rep private ActionBar actionBar;

	@Rep private EditPane editPane;
	@Rep private JSplitPane splitPane;
	@Rep private String lastSplitConfig;

	@Rep private final StatusBar status;

	@Rep private InputHandler inputHandler;
	@Rep private Macros.Recorder recorder;
	@Rep private Component prefixFocusOwner;

	@Rep private int waitCount;

	@Rep private boolean showFullPath;

	@Rep private final boolean plainView;

	@Rep private Socket waitSocket;
	@Rep private Component mainContent;

	@Rep private boolean fullScreenMode;
	@Rep private Rectangle windowedBounds;
	@Rep private JMenuBar menuBar;
	@Rep private String userTitle;
	//}}}
...
//			Log.log(Log.DEBUG, this, "appFocus:" + appFocus + " viewChanged:" + viewChanged);
	...
	{
		@Rep public int x, y, width, height, extState;
		public boolean plainView;//found by topology error
		@Rep public String splitConfig;
		@Rep public DockingLayout docking;
		public String title;//found by topology error
