...
public class ClassManagerImpl extends BshClassManager
{
	...
	*/
	@Rep private BshClassPath baseClassPath;
	@Rep private boolean superImport;
	...
	/**
		...
		in that order.
	*/
	@Rep private BshClassPath fullClassPath;

	// ClassPath Change listeners
	@Rep private Vector listeners = new Vector();
	@Rep private ReferenceQueue refQueue = new ReferenceQueue();
	...
	*/
	@Rep private BshClassLoader baseLoader;

	/**
		Map by classname of loaders to use for reloaded classes
	*/
	@Rep private Map loaderMap;
