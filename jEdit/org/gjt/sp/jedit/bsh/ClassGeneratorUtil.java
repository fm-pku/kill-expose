...
public class ClassGeneratorUtil implements Constants 
{
	...
	@Rep Class [] interfaces;
	@Rep Variable [] vars;
	@Rep Constructor [] superConstructors;
	@Rep DelayedEvalBshMethod [] constructors;
	@Rep DelayedEvalBshMethod [] methods;
	@Rep NameSpace classStaticNameSpace;
	@Rep Modifiers classModifiers;
	boolean isInterface;
