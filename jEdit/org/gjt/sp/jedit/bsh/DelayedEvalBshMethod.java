...
public class DelayedEvalBshMethod extends BshMethod
{
	...
	@Rep BSHReturnType returnTypeNode;
	@Rep String [] paramTypeDescriptors;
	@Rep BSHFormalParameters paramTypesNode;

	// used for the delayed evaluation...
	@Rep transient CallStack callstack;
	@Rep transient Interpreter interpreter;
