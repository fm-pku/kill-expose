	...
	implements Runnable, ConsoleInterface,Serializable
{
	...
	*/
	...
	@Rep NameSpace globalNameSpace;
	@Rep transient Reader in;
	@Rep transient PrintStream out;
	@Rep transient PrintStream err;
	@Rep ConsoleInterface console;

	/** If this interpeter is a child of another, the parent */
	@Rep Interpreter parent;
