...
public class BshClassManager
{
    ...
    */
    @Rep protected ClassLoader externalClassLoader;
    ...
    */
    @Rep protected transient Hashtable absoluteClassCache = new Hashtable();
    /**
        Global cache for things we know are *not* classes.
        Note: these should probably be re-implemented with Soft references.
        (as opposed to strong or Weak)
    */
    @Rep protected transient Hashtable absoluteNonClasses = new Hashtable();
    ...
    */
    @Rep protected transient Hashtable resolvedObjectMethods = new Hashtable();
    @Rep protected transient Hashtable resolvedStaticMethods = new Hashtable();

    @Rep protected transient Hashtable definingClasses = new Hashtable();
    @Rep protected transient Hashtable definingClassesBaseNames = new Hashtable();
