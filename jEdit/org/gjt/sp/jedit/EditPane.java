...
public class EditPane extends JPanel implements BufferSetListener
{
	...
	{
		@Rep public int caret = -1;
		@Rep public Selection[] selection;
		@Rep public int scrollVert = -1;
		@Rep public int scrollHoriz = -1;
		@Rep public boolean rectangularSelection;
		@Rep public boolean multipleSelection;
	} //}}}
	...
	//{{{ Instance variables
	@Rep private boolean init;
	/** The View where the edit pane is. */
	@Rep private final View view;

	@Rep private final BufferSet bufferSet;

	/** The current buffer. */
	@Rep private Buffer buffer;
	@Rep private Buffer recentBuffer;
	@Rep private BufferSwitcher bufferSwitcher;

	/** The textArea inside the edit pane. */
	@Rep private final JEditTextArea textArea;
	@Rep private final MarkerHighlight markerHighlight;
	...
	@Rep private final Map<String, CaretInfo> caretsForPath = new HashMap<String, CaretInfo>();
	...
	{
		@Rep private boolean markerHighlight;
		@Rep private Color markerHighlightColor;
