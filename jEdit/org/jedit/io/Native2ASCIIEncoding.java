...
public class Native2ASCIIEncoding implements Encoding
{
	...
	//{{{ Instance variables
	@Rep private final CharsetEncoder asciiEncoder = Charset.forName("ASCII").newEncoder();
	@Rep private final CharsetEncoding asciiEncoding = new CharsetEncoding("ASCII");
	//}}}
...
outer:
		...
		//{{{ Instance variables
		@Rep private PushbackReader in;
		@Rep private boolean permissive;
		@Rep private char[] skipBuffer;
		@Rep private boolean escaped;
		//}}}
