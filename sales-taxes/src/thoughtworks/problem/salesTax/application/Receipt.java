...
public class Receipt {
	...
	private static class ReceiptItems {
		@Rep public int quantity;
		@Rep public String name;
		@Rep public double cost;
		@Rep public double salesTax;
	...
	@Rep private ArrayList<ReceiptItems> receiptItemsList;
	@Rep private double salesTaxes;
	@Rep private double total;
	@Rep private ShoppingCart cart;
